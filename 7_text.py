...
# 시작 시간 정보
start_ticks = pygame.time.get_ticks() # 현재 시작 tick 정보를 받아옴
...
while running:
    ...
    # 타이머 집어 넣기
    # 경과 시간 계산
    elapsed_time = (pygame.time.get_ticks() - start_ticks) / 1000 # (ms)라 1000으로 나누어 초(s) 단위로 표시
    ...
    pygame.display.update() # 게임 화면을 다시 그리기 (계속 호출되어야 함)
